...
const GLOBAL_CSS = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .btn-accent { padding: 12px; border-radius: 12px; background: ${C.accent}; color: #0a0806; border: none; font-weight: 700; font-size: 14px; cursor: pointer; transition: opacity 0.2s; }
  .btn-accent:hover { opacity: 0.85; }
  .btn-ghost  { padding: 12px; border-radius: 12px; background: transparent; color: ${C.muted}; border: 1px solid ${C.border}; font-weight: 600; font-size: 14px; cursor: pointer; transition: border-color 0.2s, color 0.2s; }
